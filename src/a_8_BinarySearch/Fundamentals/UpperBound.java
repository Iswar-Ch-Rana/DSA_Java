...
public class UpperBound {
    public static void main(String[] args) {
        ...
        System.out.println(obj.upperBound(arr1, 2));
        System.out.println(obj.upperBound(arr2, 9));
        System.out.println(obj.upperBound(arr3, 3));
        System.out.println(obj.upperBound(arr4, 89401));
    }
